jQuery(document).ready(function ($) {
     ...
     * @returns {string}
     */
    window.rewrite_api_method.circle_preloader = function(width = '40', height = '40', style = 'text-align: center;margin: 15px auto 4px auto;') {
    ...
    window.loading_dialog = $.dialog({
        ...
        lazyOpen: true,
        rtl: true,
        content: '<div class="text-center">' + window.rewrite_api_method.circle_preloader() + rewrite_api.wait + '</div>',
        buttons: {},
        closeIcon: false,
    });
